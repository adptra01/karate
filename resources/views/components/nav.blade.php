                        ...
                        <div class="dropdown-menu p-4">
                            <div class="row gy-4">
                                ...
                                <div class="col-12 col-lg">
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="/auth-login-basic.html"
                                                target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Login (Basic)
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="/auth-login-cover.html"
                                                target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Login (Cover)
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="/auth-register-basic.html"
                                                target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Register (Basic)
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="/auth-register-cover.html"
                                                target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Register (Cover)
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/auth-register-multisteps.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/auth-forgot-password-basic.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/auth-forgot-password-cover.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/auth-reset-password-basic.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/auth-reset-password-cover.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                ...
                                <div class="col-12 col-lg">
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="/pages-misc-error.html"
                                                target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Error
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/pages-misc-under-maintenance.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Under Maintenance
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="/pages-misc-comingsoon.html"
                                                target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Coming Soon
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/pages-misc-not-authorized.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Not Authorized
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/auth-verify-email-basic.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Verify Email (Basic)
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link"
                                                href="/auth-verify-email-cover.html" target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Verify Email (Cover)
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="/auth-two-steps-basic.html"
                                                target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Two Steps (Basic)
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="/auth-two-steps-cover.html"
                                                target="_blank">
                                                <i class='bx bx-radio-circle me-2'></i>
                                                Two Steps (Cover)
                                            </a>
                                ...
                                <div class="col-lg-4 d-none d-lg-block">
                                    <div class="bg-body nav-img-col p-2">
                                        <img src="/assets/img/front-pages/misc/nav-item-col-img.pnghttps://cdn.dribbble.com/userupload/9654137/file/original-6dda94602ad308e3f57be1317601d945.png?resize=752x564"

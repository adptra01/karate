                ...
                e.exports = function() {
                    ...
                    var r = "active"
                      ...
                      , f = function(e, t, n, s) {
                        ...
                        if (!o._steps[t].classList.contains(r) && !o._stepsContents[t].classList.contains(r)) {
                            ...
                            a.defaultPrevented || (l.length && l[0].classList.remove(r),
                            p.length && (p[0].classList.remove(r),
                            e.classList.contains(u) || o.options.animation || p[0].classList.remove(c)),
                            v(e, o._steps[t], o._steps, n),
                            h(e, o._stepsContents[t], o._stepsContents, p, s))
                        }
                    }
                      , v = function(e, t, n, s) {
                        n.forEach((function(t) {
                            ...
                            e.classList.contains(o) && n.setAttribute("disabled", "disabled")
                        }
                        )),
                        t.classList.add(r);
                      ...
                      , h = function(e, t, n, s, o) {
                        var u = e[d]
                          , f = n.indexOf(t)
                          , v = i("shown.bs-stepper", {
                            cancelable: !0,
                            detail: {
                                from: u._currentIndex,
                                to: f,
                                indexStep: f
                            }
                        });
                    ...
                    return function() {
                        function t(t, n) {
                            ...
                            this._stepsContents = [],
                            this.options = e({}, L, {}, n),
                            this.options.selectors = e({}, L.selectors, {}, this.options.selectors),
                            ...
                            this.options.animation && s.forEach((function(e) {
                                e.classList.add(l),
                                e.classList.add(a)
                            }
                            )),
                        ...
                        return s._setLinkListeners = function() {
                            ...
                            this._steps.forEach((function(t) {
                                ...
                                e.options.linear ? (e._clickStepLinearListener = (e.options,
                                function(e) {
                                    e.preventDefault()
                                }
                                ),
                                i.addEventListener("click", e._clickStepLinearListener)) : (e._clickStepNonLinearListener = (s = e.options,
                                function(e) {
                                    e.preventDefault();

                ...
                !function (t) {
                    ...
                    !function (t) {
                        ...
                        t.fn.inputVal = function (e) {
                            ...
                            return n.is("input, textarea, select") ? void 0 === e ? r[n.attr("name")].get() : (r[n.attr("name")].set(e),
                                n) : void 0 === e ? o(r, "get") : (u(e, (function (t, e) {
                                    r[e].set(t)
                                }
                                )),
                                    n)
                        ...
                        t.fn.repeaterVal = function () {
                            var e, n, r = function (t) {
                                if (1 === t.length && (0 === t[0].key.length || 1 === t[0].key.length && !t[0].key[0]))
                                    return t[0].val;
                                u(t, (function (t) {
                                    t.head = t.key.shift()
                                }
                            ...
                            return r((e = t(this).inputVal(),
                                n = [],
                                u(e, (function (t, e) {
                                    var r = [];
                                    "undefined" !== e && (r.push(e.match(/^[^\[]*/)[0]),
                                        r = r.concat(c(e.match(/\[[^\]]*\]/g), (function (t) {
                                            return t.replace(/[\[\]]/g, "")
                                        }
                                        ))),
                                        n.push({
                            ...
                            return r = r || {},
                                t(this).each((function () {
                                    var o = t(this)
                                        ...
                                        , p = o.find("[data-repeater-list]").first()
                                        , l = function (e, n) {
                                            return e.filter((function () {
                                                return !n || 0 === t(this).closest((e = n,
                                                    "selector",
                                                    c(e, (function (t) {
                                                        return t.selector
                                                    }
                                        ...
                                        , h = function () {
                                            return l(p.find("[data-repeater-item]"), r.repeaters)
                                        }
                                        , d = p.find("[data-repeater-item]").first().clone().hide()
                                        , v = l(l(t(this).find("[data-repeater-item]"), r.repeaters).first().find("[data-repeater-delete]"), r.repeaters);
                                    r.isFirstItemUndeletable && v && v.remove();
                                    var m = function () {
                                                ...
                                                u(r.repeaters, (function (t) {
                                                    e.find(t.selector).repeater(function () {
                                                        ...
                                                        return u((t = arguments,
                                                            Array.prototype.slice.call(t)), (function (t) {
                                                                u(t, (function (t, n) {
                                                                    e[n] = t
                                                                }
                                                                ))
                                        ...
                                        , b = function (e, n, r) {
                                            e.each((function (e) {
                                                ...
                                                i.data("item-name", n + "[" + e + "]"),
                                                    l(i.find("[name]"), r).each((function () {
                                                        ...
                                                        u.attr("name", f),
                                                            y(r, i, (function (r) {
                                                                var i = t(this);
                                                                b(l(i.find("[data-repeater-item]"), r.repeaters || []), n + "[" + e + "][" + i.find("[data-repeater-list]").first().data("repeater-list") + "]", r.repeaters)
                                                            }
                                                            ))
                                                    }
                                                    ))
                                                ...
                                                p.find("input[name][checked]").removeAttr("checked").prop("checked", !0)
                                        };
                                    b(h(), m(), r.repeaters),
                                        g(h()),
                                        r.initEmpty && h().remove(),
                                        r.ready && r.ready((function () {
                                            b(h(), m(), r.repeaters)
                                        }
                                        ));
                                    var $, x = ($ = function (i, a, o) {
                                        if (a || r.defaultValues) {
                                            var f = {};
                                            l(i.find("[name]"), o).each((function () {
                                                var e = t(this).attr("name").match(/\[([^\]]*)(\]|\]\[\])$/)[1];
                                                f[e] = t(this).attr("name")
                                            }
                                            )),
                                                i.inputVal(c((s = a || r.defaultValues,
                                                    p = function (t, e) {
                                                        return f[e]
                                                    }
                                                    ,
                                        ...
                                        y(o, i, (function (e) {
                                            var n = t(this);
                                            l(n.find("[data-repeater-item]"), e.repeaters).each((function () {
                                                ...
                                                if (a && a[r]) {
                                                    ...
                                                    n.find("[data-repeater-item]").remove(),
                                                        u(a[r], (function (t) {
                                                            var r = i.clone();
                                                            $(r, t, e.repeaters || []),
                                                                n.find("[data-repeater-list]").append(r)
                                                        }
                                                        ))
                                                } else
                                                    $(t(this), e.defaultValues, e.repeaters || [])
                                            }
                                            ))
                                        }
                                        ))
                                        ...
                                        function (e, n) {
                                            p.append(e),
                                                ...
                                                $(e, n || r.defaultValues, r.repeaters)
                                        }
                                    ), k = function (t) {
                                        var e = d.clone();
                                        x(e, t),
                                    ...
                                    i = function (t) {
                                        ...
                                        ,
                                        l(o.find("[data-repeater-create]"), r.repeaters).click((function () {
                                            k()
                                        }
                                        )),
                                        p.on("click", "[data-repeater-delete]", (function () {

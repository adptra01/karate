                ...
                if (null != n) {
                    ...
                    try {
                        if (r = (n = n.call(e)).next,
                            ...
                            for (; !(l = (o = r.call(n)).done) && (a.push(o.value),
                                a.length !== t); l = !0)
                                ;
                    } catch (e) {
                        u = !0,
                ...
                if (n) {
                    ...
                    if (o) {
                        ...
                        if ("string" == typeof o && (o = document.querySelector(o)),
                            ...
                            return;
                        var r = i.scrollTop
                            , s = o - r - parseInt(i.clientHeight / 2, 10)
                            , a = +new Date;
                        !0 === e ? function e() {
                            var n, o, l, u = +new Date - a, c = (n = u,
                                o = r,
                                l = s,
                                (n /= t / 2) < 1 ? l / 2 * n * n + o : -l / 2 * ((n -= 1) * (n - 2) - 1) + o);
                            i.scrollTop = c,
                                u < t ? requestAnimationFrame(e) : i.scrollTop = s
                        }() : i.scrollTop = s
                    }
                }
            },
            ...
            setContentLayout: function () {
                ...
                setTimeout((function () {
                    ...
                    document.querySelector(".content-wrapper > .menu-horizontal > div") && (f = !0,
                        ...
                        "compact" === t ? (u.some((function (e) {
                        ...
                        )) && (e._removeClass("container-fluid", [o, l]),
                            e._addClass("container-xxl", [o, l])),
                            ...
                            f && (e._removeClass("container-fluid", n),
                                ...
                                s && (e._removeClass("container-fluid", s),
                                    ...
                                    )) && (e._removeClass("container-xxl", [o, l]),
                                        e._addClass("container-fluid", [o, l])),
                ...
                null != e && e.forEach((function (e) {
                    e.addEventListener("click", (function (t) {
                        ...
                        "text" === i.getAttribute("type") ? (i.setAttribute("type", "password"),
                            o.classList.replace("bx-show", "bx-hide")) : "password" === i.getAttribute("type") && (i.setAttribute("type", "text"),

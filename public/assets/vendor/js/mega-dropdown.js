        ...
        var o = function () {
            function t(e) {
                ...
                !function (t, e) {
                    ...
                    this._container && (this._menu = this._container.querySelector(".dropdown-toggle ~ .dropdown-menu"),
                        this._menu && (e.setAttribute("aria-expanded", "false"),
                            this._el = e,
                            this._bindEvents()))
            }
            var e, n, o;
            return e = t,
                o = [{
                    key: "_findParent",
                    value: function (t, e) {
                        if ("BODY" === t.tagName.toUpperCase())
                            return null;
                        for (t = t.parentNode; "BODY" !== t.tagName.toUpperCase() && !t.classList.contains(e);)
                            t = t.parentNode;
                ...
                (n = [{
                    ...
                    value: function () {
                        this._timeout && (clearTimeout(this._timeout),
                            ...
                            "true" !== this._el.getAttribute("aria-expanded") && (this._triggerEvent("show"),
                    ...
                    key: "_close",
                    value: function () {
                        "true" === this._el.getAttribute("aria-expanded") && (this._triggerEvent("hide"),
                    ...
                    value: function () {
                        ...
                        this._elClickEvnt = function (t) {
                            ...
                            this._focusoutEvnt = function () {
                                e._focusTimeout && (clearTimeout(e._focusTimeout),
                    ...
                    key: "_unbindEvents",
                    value: function () {
                        this._elClickEvnt && (this._el.removeEventListener("click", this._elClickEvnt),
                            this._elClickEvnt = null),
                            this._bodyClickEvnt && (document.body.removeEventListener("click", this._bodyClickEvnt, !0),
                                this._bodyClickEvnt = null),
                            this._menuClickEvnt && (this._menu.removeEventListener("click", this._menuClickEvnt, !0),
                                this._menuClickEvnt = null),
                            this._focusoutEvnt && (this._container.removeEventListener("focusout", this._focusoutEvnt, !0),
                                this._focusoutEvnt = null),
                            this._enterEvnt && (this._el.removeEventListener("mouseenter", this._enterEvnt),
                                this._menu.removeEventListener("mouseenter", this._enterEvnt),
                                this._enterEvnt = null),
                            this._leaveEvnt && (this._el.removeEventListener("mouseleave", this._leaveEvnt),
                    ...
                    value: function (t) {
                        var e;
                        document.createEvent ? ("function" == typeof Event ? e = new Event(t) : (e = document.createEvent("Event")).initEvent(t, !1, !0),
                            this._container.dispatchEvent(e)) : this._container.fireEvent("on".concat(t), document.createEventObject())
                    }
                }]) && i(e.prototype, n),
                o && i(e, o),

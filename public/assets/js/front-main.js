...
!function () {
    ...
    var l, n = document.querySelectorAll(".nav-link.mega-dropdown"), n = (n && n.forEach(e => {
        new MegaDropdown(e)
    }
    ),
        document.querySelector(".dropdown-style-switcher")), s = localStorage.getItem("templateCustomizer-" + templateName + "--Style") || window.templateCustomizer.settings.defaultStyle;
    window.templateCustomizer && n && ([].slice.call(n.children[1].querySelectorAll(".dropdown-item")).forEach(function (e) {
        ...
        n = n.querySelector("i"),
        "light" === s ? (n.classList.add("bx-sun"),
            new bootstrap.Tooltip(n, {
                title: "Light Mode",
                fallbackPlacements: ["bottom"]
            })) : "dark" === s ? (n.classList.add("bx-moon"),
                new bootstrap.Tooltip(n, {
                    title: "Dark Mode",
                    fallbackPlacements: ["bottom"]
        ...
        [].slice.call(document.querySelectorAll("[data-app-" + l + "-img]")).map(function (e) {
            var t = e.getAttribute("data-app-" + l + "-img");
